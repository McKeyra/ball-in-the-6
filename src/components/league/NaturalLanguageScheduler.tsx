...
export function NaturalLanguageScheduler(): React.ReactElement {
  ...
  const handleSubmit = async (): Promise<void> => {
    ...
    try {
      // TODO: Replace with actual AI scheduling API endpoint
  ...
  const createGamesFromResult = async (): Promise<void> => {
    ...
    // TODO: Replace with actual bulk create API
    const res = await fetch('/api/games/bulk', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify({ games: gamesToCreate }),
    });
    ...
    <div className="max-w-4xl mx-auto">
      ...
      >
        ...
        <p className="text-blue-100">
          Describe what games you want to schedule, and I&apos;ll help you set
          them up. Be as specific or general as you like!
        </p>
      </div>
          ...
          {result.error ? (
            ...
            <>
              ...
              <div className="space-y-4">
                ...
                {result.specific_matchups &&
                  result.specific_matchups.length > 0 && (
                    <div>
                      <div className="text-sm font-semibold text-gray-600 mb-2">
                        Proposed Matchups:
                      </div>
