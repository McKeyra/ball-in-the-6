...
export function CreateFormDialog({
  ...
  open,
  onOpenChange,
}: CreateFormDialogProps): React.ReactElement {
  ...
  const createMutation = useMutation({
    mutationFn: async (data: FormData) => {
      ...
      await fetch('/api/form-templates', {
        ...
        body: JSON.stringify({ program_id: program.id, ...data }),
      });
    },
    onSuccess: () => {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="bg-[#1A1A1A] border-white/10 text-white max-w-4xl max-h-[90vh] overflow-hidden flex flex-col">
        <DialogHeader>
          <DialogTitle>
            Create Registration Form for {program.name}
          </DialogTitle>
        </DialogHeader>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(val) =>
                    setFormData({ ...formData, form_type: val })
                  }
                >
              ...
              <div className="flex items-center gap-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      landing_page_slug: e.target.value,
                    })
                  }
            ...
            <div className="space-y-3 p-4 bg-white/5 rounded-lg">
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(val) =>
                    setFormData({ ...formData, payment_enabled: val })
                  }
                />
              </div>
