...
export function BaseballCap({ size = 24, className = '', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function Toque({ size = 24, className = '', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function Hoodie({ size = 24, className = '', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function LongSleeve({ size = 24, className = '', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
