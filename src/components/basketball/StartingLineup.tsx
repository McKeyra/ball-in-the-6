...
export function StartingLineup({
  ...
  draggedPlayer,
  isMobile = false,
}: StartingLineupProps): React.ReactElement {
  return (
    <div className={`grid ${isMobile ? 'grid-cols-2' : 'grid-cols-5'} gap-4`}>
      {players.map((player, index) => (
        ...
        >
          ...
          <div className="flex flex-col items-center justify-center mb-3 mt-6">
            <div
              ...
              style={{
                ...
                color: 'white',
                boxShadow:
                  '4px 4px 8px rgba(0,0,0,0.15), -2px -2px 4px rgba(255,255,255,0.5)',
              }}
            >
          ...
          {/* Quick Stats */}
          <div
            className={`flex justify-center gap-${isMobile ? '3' : '4'} mt-3 text-xs`}
          >
