...
interface GameInfo {
  ...
  homeBonusActive?: boolean;
  awayBonusActive?: boolean;
}
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        <div className="grid grid-cols-3 gap-6 items-center">
          ...
          <Card
            ...
            style={{
              background: homeTeam
                ? `linear-gradient(135deg, ${homeTeam.gradientStart}, ${homeTeam.gradientEnd})`
                : '#6B7280',
            }}
          >
          ...
          <Card
            ...
            style={{
              background: awayTeam
                ? `linear-gradient(135deg, ${awayTeam.gradientStart}, ${awayTeam.gradientEnd})`
                : '#6B7280',
            }}
          >
            <h2 className="text-xl font-bold text-white mb-3 tracking-tight">
