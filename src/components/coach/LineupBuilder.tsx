...
export function LineupBuilder({ teams }: LineupBuilderProps): React.ReactElement {
  ...
  const handleDragEnd = (result: DropResult): void => {
    ...
    if (source.droppableId === destination.droppableId) {
      const items =
        source.droppableId === 'starters' ? [...starters] : [...bench];
      ...
      const sourceItems =
        source.droppableId === 'starters' ? [...starters] : [...bench];
      const destItems =
        destination.droppableId === 'starters' ? [...starters] : [...bench];
