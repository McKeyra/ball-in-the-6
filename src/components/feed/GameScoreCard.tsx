...
export function GameScoreCard({ game, team }: GameScoreCardProps) {
        ...
        <div className="p-6">
          ...
          <div className="flex items-center justify-between mb-4">
            <div className="flex-1 text-center">
              ...
              <p
                className={`text-5xl font-bold ${won ? 'text-[#D0FF00]' : 'text-white'}`}
              >
                {game.our_score}
              </p>
            </div>
            ...
            <div className="flex-1 text-center">
              ...
              <p
                className={`text-5xl font-bold ${!won && !tied ? 'text-red-400' : 'text-white'}`}
              >
                {game.opponent_score}
              </p>
            </div>
