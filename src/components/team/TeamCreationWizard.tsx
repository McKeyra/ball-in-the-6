...
export function TeamCreationWizard({
  ...
  onCancel,
  userEmail,
}: TeamCreationWizardProps): React.ReactElement {
  ...
  const handleNext = async (): Promise<void> => {
    ...
    if (currentStep === 2 && teamData.roster.length > 0 && teamId) {
      await updateTeamMutation.mutateAsync({
        id: teamId,
  ...
  const handleRosterUpload = async (fileUrl: string): Promise<void> => {
    setExtracting(true);
    try {
      // TODO: Replace with actual roster extraction API
      ...
      if (result.status === 'success' && result.output?.players) {
        const roster: RosterPlayer[] = result.output.players.map(
  ...
  const removePlayer = async (index: number): Promise<void> => {
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          handleFieldChange('age_group', e.target.value)
                        }
                      />
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex gap-2">
                        <Input
                          ...
                          onChange={(e) =>
                            handleFieldChange('team_color', e.target.value)
                          }
                          className="w-20 h-10"
                        />
                        <Input
                ...
                <div className="space-y-6">
                  <div className="flex items-center justify-between">
                    <p className="text-slate-600">
                      Add players to your roster. You can upload a document or
                      add them manually.
                    </p>
                  </div>
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-slate-600">
                              Upload Excel, CSV, or PDF with player info
                            </p>
                          </div>
                        </div>
                        <div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      <h4 className="font-semibold text-slate-900">
                        Players ({teamData.roster.length})
                      </h4>
                      <Button
                        variant="outline"
                        size="sm"
                          ...
                          <CardContent className="p-4">
                            <div className="grid md:grid-cols-5 gap-3">
                              ...
                              <Select
                                ...
                                onValueChange={(value) =>
                                  updatePlayer(index, 'uniform_size', value)
                                }
                              >
                                <SelectTrigger>
                      ...
                      {teamData.roster.length === 0 && (
                        <div className="text-center py-12 text-slate-500">
                          ...
                          <p className="text-sm mt-1">
                            Upload a file or add players manually
                          </p>
                        </div>
                      )}
                    </div>
                  ...
                  <div className="bg-gradient-to-br from-green-50 to-emerald-50 border border-green-200 rounded-xl p-6">
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <div>
                        ...
                        <p className="text-slate-600">
                          Review your team details below
                        </p>
                      </div>
                    </div>
                  </div>
                        ...
                        <div className="pt-3 border-t space-y-2">
                          <div className="flex justify-between text-sm">
                            ...
                            <span className="font-medium">
                              {teamData.age_group || 'Not set'}
                            </span>
                          </div>
                          <div className="flex justify-between text-sm">
                            <span className="text-slate-600">Season:</span>
                            <span className="font-medium">
                              {teamData.season || 'Not set'}
                            </span>
                          </div>
                          <div className="flex justify-between text-sm">
                        ...
                        <div className="pt-4 border-t">
                          ...
                          <div className="grid grid-cols-2 gap-2 text-sm">
                            ...
                            <div className="bg-slate-50 rounded-lg p-2 text-center">
                              <p className="font-medium">
                                {
                                  teamData.roster.filter((p) => p.position)
                                    .length
                                }
                              </p>
                              <p className="text-xs text-slate-600">
