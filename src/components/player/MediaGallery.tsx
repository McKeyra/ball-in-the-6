...
import { Image as ImageIcon, Video, Plus, Grid3x3, List } from 'lucide-react';
...
export function MediaGallery({ posts }: MediaGalleryProps) {
  ...
  const allMedia: MediaItem[] = posts.reduce<MediaItem[]>((acc, post) => {
    if (post.media_urls) {
    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-2">
          <ImageIcon className="w-5 h-5 text-[#D0FF00]" />
