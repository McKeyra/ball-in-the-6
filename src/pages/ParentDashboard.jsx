    ...
    <div className="min-h-screen bg-[#0f0f0f] p-4 md:p-8">
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-white/40">Manage payments, schedules & academics</p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-4 mb-8">
          ...
          <Card className="bg-gradient-to-br from-red-500/20 to-pink-500/20 border-red-500/30">
            <CardContent className="p-6">
              ...
              <p className="text-3xl font-bold text-white">$125.00</p>
          ...
          <Card className="bg-gradient-to-br from-blue-500/20 to-cyan-500/20 border-blue-500/30">
            <CardContent className="p-6">
              ...
              <p className="text-3xl font-bold text-white">$660.00</p>
        ...
        <div className="grid lg:grid-cols-3 gap-6">
              ...
              <CardHeader className="flex flex-row items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-white/40">Payments & invoices</p>
                  </div>
                </div>
                ...
                {mockPayments.map((payment) => (
                  ...
                  >
                    <div className="flex-1">
                      <p className="font-medium text-white mb-1">{payment.description}</p>
                    ...
                    <div className="text-right">
                      ...
                      {payment.status === 'pending' && (
                        <Button size="sm" className="mt-2 bg-[#c9a962] text-[#0A0A0A] hover:bg-[#c9a962]/90">
                          Pay Now
                        </Button>
                      )}
                    </div>
            ...
            <Card className="bg-white/[0.05] border-white/[0.06]">
              <CardHeader>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <CardTitle>Academic Tracker</CardTitle>
                    <p className="text-sm text-white/40">Monitor school performance</p>
                  </div>
                </div>
              </CardHeader>
              <CardContent className="space-y-4">
                ...
                <Button variant="outline" className="w-full border-white/[0.06] mt-4">
          ...
          <div className="space-y-6">
              ...
              <CardHeader>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-white/40">Upcoming events</p>
                  </div>
                </div>
              </CardHeader>
              <CardContent className="space-y-3">
                {mockSchedule.map((event) => (
                  <div 
                    key={event.id}
                    className="p-3 bg-white/[0.05] rounded-lg border-l-4 border-[#c9a962]"
                  >
            ...
            <Card className="bg-white/[0.05] border-white/[0.06]">
              ...
              <CardContent className="space-y-3">
                <div className="p-3 bg-white/[0.05] rounded-lg flex items-center justify-between">
                  <div className="flex items-center gap-3">
