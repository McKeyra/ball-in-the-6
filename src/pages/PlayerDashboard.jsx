    ...
    <div className="min-h-screen bg-[#0f0f0f] p-4 md:p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-white/40">Your athlete dashboard & brand hub</p>
        </div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          <Card className="bg-gradient-to-br from-white/5 to-white/10 border-white/[0.06]">
            <CardContent className="p-6">
              ...
              <p className="text-sm text-white/40">Active Teams</p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gradient-to-br from-white/5 to-white/10 border-white/[0.06]">
            <CardContent className="p-6">
              ...
              <p className="text-sm text-white/40">Stats Logged</p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gradient-to-br from-white/5 to-white/10 border-white/[0.06]">
            <CardContent className="p-6">
              ...
              <p className="text-sm text-white/40">NIL Earnings</p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gradient-to-br from-white/5 to-white/10 border-white/[0.06]">
            <CardContent className="p-6">
              ...
              <p className="text-sm text-white/40">Goals Complete</p>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card className="bg-gradient-to-br from-[#c9a962]/10 to-yellow-500/10 border-[#c9a962]/30 overflow-hidden">
              <div className={`h-32 bg-gradient-to-br ${profileColor} relative`}>
              ...
              <CardContent className="p-6 -mt-8 relative z-10">
                <div className="w-16 h-16 bg-[#c9a962] rounded-2xl flex items-center justify-center mb-4 shadow-lg">
                  <Shirt className="w-8 h-8 text-[#0A0A0A]" />
                </div>
                <h3 className="text-2xl font-bold text-white mb-2">Your NIL Merch Store</h3>
                ...
                <div className="flex gap-3">
                  <Button className="bg-[#c9a962] text-[#0A0A0A] hover:bg-[#c9a962]/90 flex-1">
                    Launch Store
                  </Button>
            ...
            <Card className="bg-white/[0.05] border-white/[0.06]">
              <CardHeader className="flex flex-row items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <CardTitle>College Recruiting Résumé</CardTitle>
                    <p className="text-sm text-white/40">NCAA-compliant PDF + highlight reel</p>
                  </div>
                </div>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex gap-3">
                  <Button variant="outline" className="flex-1 border-white/[0.06]">
            ...
            <Card className="bg-white/[0.05] border-white/[0.06]">
              ...
              <CardContent>
                {stats.length === 0 ? (
                  <p className="text-white/40 text-center py-8">No stats recorded yet</p>
                ) : (
                  <div className="space-y-2">
                    {stats.slice(0, 5).map((stat, idx) => (
                      <div key={idx} className="flex items-center justify-between p-3 bg-white/[0.05] rounded-lg">
                        <div>
            ...
            <Card className="bg-white/[0.05] border-white/[0.06]">
              ...
              <CardContent>
                <div className="p-4 bg-white/[0.05] rounded-lg">
                  <p className="text-sm text-white/40 mb-1">Saturday, Nov 16</p>
                  <p className="font-semibold text-white mb-2">vs Toronto Elite</p>
                  <p className="text-xs text-white/40">7:00 PM • Home Court</p>
                </div>
              </CardContent>
            </Card>
