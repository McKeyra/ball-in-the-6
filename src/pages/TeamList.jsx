    ...
    <div className="min-h-screen bg-[#0f0f0f] p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-4xl font-bold text-white/90 mb-2">Teams</h1>
            <p className="text-white/60">Manage your basketball teams</p>
          </div>
          <Button
        ...
        {teams.length === 0 ? (
          ...
          >
            <Users className="w-20 h-20 mx-auto mb-4 text-white/30" />
            <h3 className="text-2xl font-bold text-white/70 mb-2">No Teams Yet</h3>
              ...
              >
                ...
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-bold text-white/90">{team.team_name}</h3>
                    <p className="text-sm text-white/40">{team.division}</p>
                  </div>
                </div>
                ...
                <div className="flex justify-around pt-4 border-t border-white/[0.06]">
                  <div className="text-center">
                    <div className="text-2xl font-bold text-white/70">{team.roster?.length || 0}</div>
                    <div className="text-xs text-white/40">Players</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-white/70">{team.staff?.length || 0}</div>
